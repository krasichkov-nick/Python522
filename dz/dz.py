...
#         result.append({'id_artist': int(id_artist), 'artist_name': artist_names.text, 'artist_genre': artist_genres,
...
<ul>
{% for c in pages %}
    <li><a href="/{{c.url}}" {% if c.title == 'Главная' %}class="active"{% endif %}>{{c.title}}</a></li>
{% endfor %}
</ul>
"""
