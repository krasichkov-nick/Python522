...
#     def __del__(self):
#         print("*" * 50)
#         print(f"Счет #{self.num} принадлежащий {self.surname} закрыт!")
#
#     @classmethod
...
#
#
# p1 = UserData("Волков Игорь Николаевич", 26, "1234 456780", 80.8)
# p1.fio = "Волков Игорь Викторович"
# p1.old = 32
# p1.password = "3216 855456"
# p1.weight = 70.9
# print(p1.__dict__)
